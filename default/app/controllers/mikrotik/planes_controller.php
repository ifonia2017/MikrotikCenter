...
Load::models('mikrotik/mikrotik');
 class PlanesController extends BackendController
 {
 	protected function before_filter() {
		//Se cambia el nombre del módulo actual
		$this->page_module = 'Gestión de planes';
	}
	...
	public function listar()
	{
		...
		$this->lista = $util->setMenu('/tool user-manager profile');

		$this->page_title = 'Lista de Planes';
	}
 }