...
class Breadcrumb
{
    ...
    private $attrs = Array(
        'separator' => '&nbsp; / &nbsp;',
        'class_ul' => 'breadcrumb pull-right',
    ...
    public function display()
    {
        ...
        do
        {
            ...
            {
                prev($this->_path);
                $html[] = "<li>" . Html::link($crumb['url'], $crumb['title']) . "</li>".PHP_EOL;
            }
            elseif(!empty($crumb['title']))
            {
                $html[] = "<li class='active'><a href='javascript: void(0)'>{$crumb['title']}</a></li>".PHP_EOL;
            }
